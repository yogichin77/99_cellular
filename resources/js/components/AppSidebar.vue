...
import { User, Table, LayoutGrid, Package, Tags, Users,ShoppingBag } from 'lucide-vue-next';
...
const navConfig: Record<string, NavItem[]> = {
    kasir: [
        ...
        { title: 'Point Of Sales', href: '/point_of_sales', icon: ShoppingBag},
    ],
    ...
    admin: [
        ...
        { title: 'Data Transaksi', href: '/data_transaksi', icon: Table },
